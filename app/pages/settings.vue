    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            v-if="mobile"
            class="d-flex align-center border-b pa-3"
          >
            <v-btn
              icon="mdi-menu"
              variant="text"
            ...
            <span class="text-subtitle-1 font-weight-medium text-capitalize ml-2">
          ...
          >
            ...
            >
              <v-card flat>
                <v-card-title class="align-center d-flex font-weight-bold text-h5 mb-4">
                  Project Sharing
